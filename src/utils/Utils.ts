...
export const formatDateToMonthShort = (value: any, toTimeForCurrentDay = true) => {
	...
	let formatting = { month: "short", day: "numeric" } as object;
...
export const getUserData = () => JSON.parse(localStorage.getItem("userData") as string);
...
export const selectThemeColors = (theme: any) => ({
	...
	colors: {
		...theme.colors,
		primary25: "#0462A71a", // for option hover bg-color
		primary: "#0462A7", // for selected option bg-color
		neutral10: "#0462A7", // for tags bg-color
